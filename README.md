...
- 🔧 关注 STM32、ESP32-S3、FreeRTOS 与嵌入式系统开发
- ⚡ 学习模拟电子技术、数字电子技术及软硬件系统集成
- 🧩 实践传感器采集、执行器控制、串口通信、显示与供电设计
- 📚 重视 README、接线说明、调试记录、测试验证和可复现交付
...
| 项目 | 简介 | 主要技术 |
| --- | --- | --- |
| [Smart Home Controller](https://github.com/yythlss/Smart-Home-Controller) | 集环境感知、毫米波雷达、串口屏、微信小程序与设备控制于一体的智能家居终端 | ESP32-S3 · ESP-IDF · C++ |
| [FreeRTOS Warehouse System](https://github.com/yythlss/FreeRTOS-Warehouse-Count-Access-System) | 基于实时任务、双路超声波和 TF 卡日志的仓库人数统计与门禁系统 | STM32 · FreeRTOS · FatFs |
| [Smart Desktop Pet](https://github.com/yythlss/Smart-Desktop-Pet) | 优化舵机供电并加入 ASRPRO 离线语音交互的桌面电子宠物 | STC11 · ASRPRO · UART |
| [Temperature Limit Alarm](https://github.com/yythlss/Temperature-Limit-Alarm-Based-on-Analog-Electronics) | 使用 NTC、LM358 与 NE555 实现的纯模拟高低温声光报警系统 | 模拟电路 · Multisim |
| [Four-Channel Responder](https://github.com/yythlss/Time-Limited-Four-Channel-Responder-Based-on-Digital-Circuits) | 基于 74LS 系列芯片的四路限时抢答、锁存与报警系统 | 数字电路 · 74LS · NE555 |
...
[![GitHub activity graph](https://github-readme-activity-graph.vercel.app/graph?username=yythlss&bg_color=EFFAFD&color=17324D&line=4A8BDF&point=A0006D&area=true&hide_border=true)](https://github.com/yythlss)
